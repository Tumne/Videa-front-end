...
var ContentListService = function(httpService, accountService){
	this._httpService = httpService;
	this._accountService = accountService;
	this._url = '/api/v1/accounts/';
	this._resource = '/contentLists/';
};

_.extend(ContentListService.prototype, {
	getAccount: function () {
	...
	removeContentNode : function(id, contentNodeId) {
		return this._httpService.doDelete(this._url + this.getAccount() + this._resource + id + '/content/' + contentNodeId);
	}
});

module.exports = ContentListService;
