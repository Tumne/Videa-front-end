...
var UISettingsEdit = function (){

};

Implements(UISettingsEdit, IView);

UISettingsEdit.prototype = {
    getName: function(){
        return 'uiSettingsEditComponent';
    },
    getDefinition: function(){
        return {
            controller: ['$scope', 'screenService', 'uiConfigurationService', 'appService', 
                ...
                this.ignore = ['_metadata', 'id', 'name', 'createdDate', 'modifiedDate', 'screenId'];
                this.screenNames = [];
                this.screenIds = [];
                this.screenId = '';
                this.configNames = [];
                ...
                for(var i in PluginModelType.EDIT.SCREEN){
                    this.screenSchemas.push(PluginModelType.EDIT.SCREEN[i]);
                } 
                ...
                if (this.screen) {
                    ...
                    this._screenService.getScreens(_this._scope.options.account,
                        ...
                        for(var i = 0; i < screens.length; i++){
                            if (_this.screenSchemas.indexOf(screens[i].getFieldValue('_metadata')) > -1) {
            ...
            template:[
                ...
                '            <div class="title">Default Screen</div>',
    ...
    getDirective : function() {
        return '<ui-settings-edit-component></ui-settings-edit-component>';
    }
};

module.exports = UISettingsEdit;
