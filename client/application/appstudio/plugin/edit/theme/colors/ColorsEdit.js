...
var ColorsEdit = function (){

};

Implements(ColorsEdit, IView);

ColorsEdit.prototype = {
    getName: function(){
        return 'colorsEditComponent';
    },
    getDefinition: function(){
        return {
            controller: ['$scope', 'modelOperation', function($scope, modelOperation){
                ...
                this.options = Digi.clone(this._scope.options);
                this.options.prefer = 1;
            ...
            replace: true,
            scope: false,
            templateUrl: 'appstudio/plugin/edit/theme/colors/colorsEdit.html'
        };
    },
    getDirective : function() {
        return '<colors-edit-component></colors-edit-component>';
    }
};

module.exports = ColorsEdit;